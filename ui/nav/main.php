  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" id="jobs-tab-button" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Jobs <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#" id="jobs-tab-btn" class="main-navigation-button" data-target="jobs-layout-parent"><span class="glyphicon glyphicon-road" aria-hidden="true"></span> Jobs Tab</a></li>
